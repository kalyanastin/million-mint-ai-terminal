        ...
        <section id="hero">
          <div className="w-full flex justify-center text-center pointer-events-auto px-4">
            <div className="max-w-[900px] flex flex-col items-center">
              ...
              <p className="description mt-4 text-center" style={{ maxWidth: "650px" }}>
                A blockchain-powered universe where creators own what they build and earn from what they create.
              </p>
          ...
          <div className="px-4 w-full flex justify-center">
            <GlassModule>
              ...
              <p className="description">
                Million Mint is a next-generation virtual universe where ownership belongs to the people who create value.
              </p>
        ...
        <section id="land">
          <div className="px-4 w-full flex justify-center">
            <GlassModule>
              ...
              <p className="description">
                Every great civilization begins with land. Acquire digital territories. Develop cities. Create experiences. Build businesses. Everything you create belongs to you.
              </p>
        ...
        <section id="create">
          <div className="px-4 w-full flex justify-center">
            <GlassModule>
              ...
              <p className="description">
                Design worlds. Construct landmarks. Launch virtual businesses. Create experiences for others. Transform imagination into reality.
              </p>
              <p className="description mt-6 highlight">
        ...
        <section id="earn">
          <div className="px-4 w-full flex justify-center">
            <GlassModule>
              ...
              <p className="description">
                Million Mint rewards builders, creators, and innovators. Earn through land development, digital businesses, asset creation, marketplace activity, and community participation.
              </p>
              <div className="data-grid">
                <div className="data-card">
        ...
        <section id="economy">
          <div className="px-4 w-full flex justify-center">
            <GlassModule>
              ...
              <p className="description">
                Every asset. Every transaction. Every creation. Contributes to a growing digital economy. Trade resources. Exchange assets. Build industries. Power entire civilizations.
              </p>
        ...
        <section id="ecosystem">
          <div className="px-4 w-full flex justify-center">
            <GlassModule>
              ...
              <p className="description">
                Explore unique planets. Visit creator-built cities. Discover new opportunities. Connect with a global community. Every world becomes part of a larger universe.
              </p>
            ...
            <GlassModule className="text-center max-w-[800px] flex flex-col items-center">
              ...
              <div className="mt-10 flex flex-col items-center border-t border-[rgba(255,255,255,0.06)] pt-6 w-full">
                ...
                <p className="mt-2 text-[11px] font-mono text-zinc-500">
                  Building the infrastructure for the next generation of digital worlds.
                </p>
              </div>
            </GlassModule>
          </div>
